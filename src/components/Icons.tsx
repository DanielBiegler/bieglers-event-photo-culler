// Minimal inline SVG icons. 16px, currentColor, no fills unless noted.
...
export const LoupeIcon = (p: SVGProps<SVGSVGElement>) => (
  <svg {...base(p)}>
...
export const RejectIcon = (p: SVGProps<SVGSVGElement>) => (
  <svg {...base(p)}>
